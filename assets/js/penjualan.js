...
//    });
    ...
    $('#btn_simpan_penjualan').click(function() {
        var form_action = $('#frm_penjualan').attr('action');
        var data = $('#frm_penjualan').serialize();
        var url = $('#frm_penjualan').attr('data-url');
...
function show_detail_penjualan(url) {
...
function total_penjualan() {
    var no_bukti = $('#no_bukti').val();
    var url = $('#total_penjualan').attr('data-url');
